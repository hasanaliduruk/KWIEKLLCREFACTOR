...
from tkinter import Canvas, Frame, Label, Text, PhotoImage, StringVar, WORD, X, RIGHT, LEFT
from threading import Thread

from utils.file_operations import browse_directory, placeholder_saver, path_text_function, relative_to_assets
...
def render_converter_view(canvas, canvas2, main_frame_resize, window, color, line_color, canvas2_text_color, dosyalar_dictionary):
